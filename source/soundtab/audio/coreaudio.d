...
bool initAudio() {
    ...
    hr = CoCreateInstance(&CLSID_MMDeviceEnumerator, null,
                     ...
                     cast(void**)&pEnum);
    if (hr != S_OK) {
        Log.e("Cannot instanciate MMDeviceEnumerator");
        return false;
    }
    Log.d("Trying to get list of audio devices");
    ...
    for (DWORD i = 0; i < count; i++) {
        ...
        if (!hr) {
            ...
            if (!hr) {
                ...
                hr = propStore.GetValue(DEVPKEY_Device_FriendlyName, varName);
                //propStore.
                BSTR s = varName.bstrVal;
                friendlyName = fromWstringz(s);
            }
