...
extern(Windows) @nogc nothrow {
    ...
    alias da_WTOpen = HCTX function ( HWND, LOGCONTEXT *, int );
    alias da_WTGet = int function ( HCTX, LOGCONTEXT * );
    alias da_WTSet = int function ( HCTX, LOGCONTEXT * );
    alias da_WTClose = int function ( HCTX );
    alias da_WTEnable = int function ( HCTX, int );
    alias da_WTPacket = int function ( HCTX, uint, void * );
    alias da_WTOverlap = int function ( HCTX, int );
    alias da_WTSave = int function ( HCTX, void * );
    alias da_WTConfig = int function ( HCTX, HWND );
    alias da_WTRestore = HCTX function ( HWND, void *, int );
    alias da_WTExtSet = int function ( HCTX, uint, void * );
    alias da_WTExtGet = int function ( HCTX, uint, void * );
    alias da_WTQueueSizeSet = int function ( HCTX, int );
    alias da_WTDataPeek =  int function ( HCTX, uint, uint, int, void *, int*);
    alias da_WTPacketsGet = int function (HCTX, int, void *);
    alias da_WTMgrOpen = HMGR function ( HWND, uint );
    alias da_WTMgrClose = int function ( HMGR );
    alias da_WTMgrDefContext = HCTX function ( HMGR, int );
    alias da_WTMgrDefContextEx = HCTX function ( HMGR, uint, int );
}
